    ...
    <div id="general">
        ...
        <div id="principal">
            <div id="nuevoformulario">
                ...
                <div id="atras">
                    <input type="buton" id="btnatras" value="Atrás"onclick="location.href='ListaFormulariox.php'";>   
                </div>
            </div>
            <div id="superior">
                <div id="caja">
                    <div id="cajainput">
                        ...
                        <input type="datetime-local" name="fechaingreso" class="inputformat" value="<?php if (isset($_GET['ID'])) {print $formdata[0][4];}else echo "x";?>"required/>
                    </div>
                    <div id="cajainput">
                        <label for="txtresponsable" class="labelformat">Seleccione el Responsable</label></br>
                        <input type="text" id="txtresponsable" name="txtresponsable" placeholder="" class="inputformat" readonly="readonly"
                        value="<?php if (isset($_GET['ID'])) {print $formdata[0][8];}?>" />  
                    </div>
                </div>
                <div id="caja">
                    <div id="cajainput">
                    ...
                    <div id="cajainput">
                        ...
                        <input type="text" id="selectsala" name="selectsala" placeholder="" class="inputformat" readonly="readonly"
                        value="<?php if (isset($_GET['ID'])) {print $formdata[0][9];}?>" /> 
            ...
            <div id="inferior">
                <div id="cajade3">
                    <div class="cajainput2">
                        ...
                        <input type="text" id="placavehiculo" class="inputformat" name="placavehiculo" value="<?php if (isset($_GET['ID'])) {print $formdata[0][10];}?>">
                    </div>      
                    <div class="cajainput2">
                        <label for="detalleequipo" class="labelformat">Detalle Equipo</label>
                        <input type="text" id="detalleequipo" class="inputformat" name="detalleequipo" value="<?php if (isset($_GET['ID'])) {print $formdata[0][11];}?>">
                    </div>
                    <div class="cajainput2">
                        <label for="txtrfc" class="labelformat">RFC          :</label>
                        <input type="text" id="txtrfc" name="txtrfc" placeholder="" class="inputformat" value="<?php if (isset($_GET['ID'])) {print $formdata[0][12];}?>"/>
                    </div>  
                </div>
                <div id="cajade3">
                    <label for="motivovisita" class="labelformat">Motivo Visita</label>
                    <input type="text" id="motivovisita" name="motivovisita" value="<?php if (isset($_GET['ID'])) echo $formdata[0][3];?>">
                </div>
            </div>  
        </div>
        <div id="derecha">
...
<script>
    ...
    //Elimina el registro de la tabla modal para que no sea seleccionado nuevamente
    /*fucntion EliminaRegistroVisiante(){
